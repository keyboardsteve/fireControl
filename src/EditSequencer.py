...
# -*- coding: CP1252 -*-
#
# generated by wxGlade 0.7.2 on Sat Jan 21 18:21:42 2017
#
...
class EditSequencer(wx.Frame):
    def __init__(self, *args, **kwds):
        # begin wxGlade: EditSequencer.__init__
        ...
        # end wxGlade
        self.text_ctrl_Channel.Bind(wx.EVT_SET_FOCUS, self.OnCursor_Channel)
        self.text_ctrl_Time.Bind(wx.EVT_SET_FOCUS, self.OnCursor_Time)

    def __set_properties(self):
        # begin wxGlade: EditSequencer.__set_properties
        self.SetTitle(_("Sequencer Edit"))
    ...
    def OnButton_Key(self, event):  # wxGlade: EditSequencer.<event_handler>
    ...
    def OnButton_Add(self, event):  # wxGlade: EditSequencer.<event_handler>
        print "Event handler 'OnButton_Add' not implemented!"
        event.Skip()

    def OnButton_Remove(self, event):  # wxGlade: EditSequencer.<event_handler>
        print "Event handler 'OnButton_Remove' not implemented!"
        event.Skip()

    def OnButton_Close(self, event):  # wxGlade: EditSequencer.<event_handler>
        self.Close()
        
    def OnCursor_Channel(self, event):
        #print "Channel has the cursor"
